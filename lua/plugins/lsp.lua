    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        local map = function(keys, func, desc)
          vim.keymap.set({ 'n', 'x', 'o', 'v' }, keys, func, { buffer = event.buf, desc = 'LSP: ' .. desc })
        end
        ...
        map('<leader>cf', vim.lsp.buf.code_action, '[C]ode [F]ixes')
        ...
        if client and client.server_capabilities.documentHighlightProvider and not vim.g.vscode then
